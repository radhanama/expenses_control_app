...
import 'package:expenses_control_app/models/estatisticas/relatorio_avancado.dart';

class DashboardService {
  IEstrategiaDashboard _estrategiaComum = RelatorioComum();
  IEstrategiaDashboard _estrategiaAvancada = RelatorioAvancado();

  void setEstrategiaComum(IEstrategiaDashboard estrategiaComum) =>
      _estrategiaComum = estrategiaComum;
  void setEstrategiaAvancada(IEstrategiaDashboard estrategiaAvancada) =>
      _estrategiaAvancada = estrategiaAvancada;
